        ...
        ***********************************-->
        ...
        <div class="container">
                        ...
                        <div class="card col-lg-8">
                            <div class="card-body">
                                <div class="card-title">Send the amount to the following USDT address</div>
                                <div class="d-block">
                                    <div class="card-img">
                                    <hr>
                                    </div>
                                    TYX2RdKiFErCzsjbT2PBonh4NaEeuSSk2Z
        ...
        <div class="modal fade" id="mymodal">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <form method="post">
                <div class="form-group">
                  <label>Enter the Address you sent USDT from</label>
