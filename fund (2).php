    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <div class="container">
                           ...
                           <h2 class=""> Binance coin</h2>
                                     
                  
                        <div class="card col-lg-8">
                            <div class="card-body">
                                <div class="card-title">Send the amount to the following Binance coin address</div>
                                <div class="d-block">
                                    <div class="card-img">
                                    <img class="img-fluid" src="./images/eth.jpg" alt="qr-code"/><hr>
                                    </div>
                                    0x4e22e4ce48d8922e4c7dd5985b203c6742e8c47d
      ...
      <div class="abf-list">
        ...
        <div class="abf-list-item">
          <div class="abf-label d-inline"><b>Amount to pay:</b></div>
          <div class="abf-value d-inline float-right"><span class="abf-totalbtc">the amount</span> </div>
        </div>
        <div class="abf-list-item">
        ...
        <div class="abf-list-item">
          <div class="abf-label d-inline"><b>Remains to pay:</b></div>
          <div class="abf-value d-inline float-right"><b><span class="abf-remains">the amount</span> </b></div>
        </div>
        <div class="abf-list-item">
          <div class="abf-label d-inline"><b>Date:</b></div>
          <div class="abf-value d-inline float-right">13-02-2023</div>
        </div>
        ...
        <div class="modal fade" id="mymodal">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <form method="post">
                <div class="form-group">
                  <label>Enter the Address you sent Binance coin from</label>
